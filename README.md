...
- `$work-research [1|2] <Slack 링크>`: 관련 이력과 현재 근거를 다시 검사합니다. 검수에 필요한 Slack 첨부파일이나 연결 문서는 내려받아 확인할 수 있습니다. `1`은 재발 방지 관점과 현재 요청 관점을 함께 제시하고, `2`는 고객사가 요청한 내용에 집중합니다. 번호를 생략하면 `2`로 동작합니다.
