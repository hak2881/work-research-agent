...
4. Repositories accessible to the connected Git-hosting identity whose name, description, topics, or linked documentation identify the project.

Do not assign every repository owned by an account to every customer. Record ambiguous candidates for review.
